...
DiskDriveHEX.Levels = {
 ...
 {name = "", difficulty = "CUSTOM", speed = 4.6 , bestTime = 0},
}
...
DiskDriveHEX.CustomSettings = {
 palette1Light = Color(36, 36, 36, 255),
 palette1Dark = Color(0, 0, 0, 255),
 palette1Object = Color(255, 0, 0, 212),
 palette1Invert = Color(255, 0, 0, 255),
 palette2Light = Color(0, 0, 0, 255),
 palette2Dark = Color(36, 36, 36, 255),
 palette2Object = Color(0, 160, 255, 212),
 palette2Invert = Color(0, 160, 255, 255),
 customSpeed = 4.6,
 customName = "EX.DISKDRIVE",
 customMusic = "DiskDriveCHM/Courtesy.wav",
 showPlayerInfo = true,
 showInputDisplay = false,
 enableColorPad = false, -- 自定义色板参数
 enableRandomRotation = true, -- 自定义转圈转圈转圈圈参数
...
function DiskDriveHEX.LoadCustomSettings()
 if file.Exists("DiskDriveHexagon_custom.txt", "DATA") then
     ...
     if data then
         DiskDriveHEX.CustomSettings.palette1Light = Color(data.palette1Light.r or 36, data.palette1Light.g or 36, data.palette1Light.b or 36, data.palette1Light.a or 255)
         DiskDriveHEX.CustomSettings.palette1Dark = Color(data.palette1Dark.r or 0, data.palette1Dark.g or 0, data.palette1Dark.b or 0, data.palette1Dark.a or 255)
         DiskDriveHEX.CustomSettings.palette1Object = Color(data.palette1Object.r or 255, data.palette1Object.g or 0, data.palette1Object.b or 0, data.palette1Object.a or 212)
         DiskDriveHEX.CustomSettings.palette1Invert = Color(data.palette1Invert.r or 255, data.palette1Invert.g or 0, data.palette1Invert.b or 0, data.palette1Invert.a or 255)
         DiskDriveHEX.CustomSettings.palette2Light = Color(data.palette2Light.r or 0, data.palette2Light.g or 0, data.palette2Light.b or 0, data.palette2Light.a or 255)
         DiskDriveHEX.CustomSettings.palette2Dark = Color(data.palette2Dark.r or 36, data.palette2Dark.g or 36, data.palette2Dark.b or 36, data.palette2Dark.a or 255)
         DiskDriveHEX.CustomSettings.palette2Object = Color(data.palette2Object.r or 0, data.palette2Object.g or 160, data.palette2Object.b or 255, data.palette2Object.a or 212)
         DiskDriveHEX.CustomSettings.palette2Invert = Color(data.palette2Invert.r or 0, data.palette2Invert.g or 160, data.palette2Invert.b or 255, data.palette2Invert.a or 255)
         DiskDriveHEX.CustomSettings.customSpeed = data.customSpeed or 4.6
         DiskDriveHEX.CustomSettings.customName = data.customName or "EX.DISKDRIVE"
         ...
         DiskDriveHEX.CustomSettings.enableRandomRotation = data.enableRandomRotation or true
...
function DiskDriveHEX.Update(dt)
 ...
 if DiskDriveHEX.RandomRotation.active and DiskDriveHEX.RandomRotation.isRotating then
      ...
      if not DiskDriveHEX.GameOverFreeze then -- 转速增加
         ...
         -- 嘿嘿，我不写注释，猜猜这是啥(邪恶)
         local rotationIncreaseInterval = DiskDriveHEX.Difficulty.rotationIncreaseInterval
         local rotationIncreaseAmount = DiskDriveHEX.Difficulty.rotationIncreaseAmount
         if (currentTime - DiskDriveHEX.StartTime) > 60 then
            local timePast60 = (currentTime - DiskDriveHEX.StartTime) - 60
            local growthFactor = math.pow(1.001, timePast60)
            rotationIncreaseAmount = rotationIncreaseAmount * growthFactor
            rotationIncreaseInterval = math.max(1, rotationIncreaseInterval / growthFactor)
         end
         if currentTime - DiskDriveHEX.Difficulty.lastRotationIncrease > rotationIncreaseInterval then
             DiskDriveHEX.Difficulty.rotationSpeed = DiskDriveHEX.Difficulty.rotationSpeed + rotationIncreaseAmount
             DiskDriveHEX.Difficulty.lastRotationIncrease = currentTime
             difficultyRotationSpeed = DiskDriveHEX.Difficulty.rotationSpeed -- 速度增加
         end
      end
 ...
 -- 难度递增（邪恶）
 local obstacleIncreaseInterval = DiskDriveHEX.Difficulty.obstacleIncreaseInterval
 local obstacleIncreaseAmount = DiskDriveHEX.Difficulty.obstacleIncreaseAmount
 if DiskDriveHEX.Score > 60 then
    local timePast60 = DiskDriveHEX.Score - 60
    local growthFactor = math.pow(1.001, timePast60)
    obstacleIncreaseAmount = obstacleIncreaseAmount * growthFactor
    obstacleIncreaseInterval = math.max(2, obstacleIncreaseInterval / growthFactor)
 end
 if currentTime - DiskDriveHEX.Difficulty.lastObstacleIncrease > obstacleIncreaseInterval then
     DiskDriveHEX.Difficulty.obstacleSpeed = DiskDriveHEX.Difficulty.obstacleSpeed + obstacleIncreaseAmount
